...
func _run() -> void:
	...
	assert(hub.find_child("Bookshelf", true, false) == null, "bookshelf is painted into the floor")
	assert(hub.find_child("Bestiary", true, false) == null, "bestiary is painted into the floor")
	assert(hub.find_child("Monument", true, false) == null, "records board is painted into the floor")
	assert(hub.find_child("PetBed", true, false) == null, "pet furniture is painted into the floor")
	assert(hub.find_child("CoderDesk", true, false) == null, "coder desk is painted into the floor")
	assert(hub.find_child("Coffee", true, false) == null, "coffee station is painted into the floor")
