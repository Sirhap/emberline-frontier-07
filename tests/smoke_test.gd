...
func _run_smoke_test() -> void:
	...
	assert(mech_npc.position.y > (shelves[0] as Vector2).y, "Top NPCs stand on the south-door side of their counters")
	assert(sum_npc.position.y < (shelves[4] as Vector2).y, "Bottom NPCs stand on the north-door side of their counters")
