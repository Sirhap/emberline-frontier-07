...
func _run() -> void:
	...
	await _shot(hero, cam, Vector2(shop_x + 240.0, top_shelf_y + 90.0), Vector2(shop_x + 310.0, top_shelf_y + 40.0), 1.02, "/opt/cursor/artifacts/rooms_upper.png")
	## North railing mouth
	...
	await _shot(hero, cam, Vector2(shop_x + 240.0, bot_shelf_y - 90.0), Vector2(shop_x + 380.0, bot_shelf_y - 40.0), 1.02, "/opt/cursor/artifacts/rooms_lower.png")
	print("NPC_QA_PASS")
	quit(0)
