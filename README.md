...
Godot 4.7、1280×720。进程入口是 `scenes/app_root.tscn`：冷启动全屏选人（骑士 / 刺客），再进家园，点「开始远征」开塔防。战场是三间地牢房（北上房间、中间 COMBAT_ROOM、南下房间）。50 秒准备 → 作战 → 清场 +50 金币，核心一侧掉 3 个传送带奖励。第 1–10 波是可玩闭环。没有 5 波通关。烟测仍直接加载 `main.tscn`，默认骑士局。
