...
- 准备期走近柜台（约 110px）点货买入。武器进双槽，炮台进英雄仓库（同种叠数）。炮台手点空地砖放下，准备和作战都行。武器手点空炮台把当前武器装上；点已有武器的炮台则交换。上厅机械师 / 商人站自己柜台南侧（朝门口）；下厅反向，召唤师 / 导师站自己柜台北侧（朝门口），军官无柜台、与两侧拉开距离。中间过道不摆货摊。买完对应 NPC 跑到该台座播补货动画后回站位（第 1 波 pulse / burst / frost）。开战不退武器槽。空建造垫是灰金属台+绿箭头；装枪后仍占座。
