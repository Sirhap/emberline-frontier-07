...
人物等级、击杀经验、三选一天赋、家园、人物选择、武器/敌人图鉴是 2026-09-01 已明确批准的新目标，按 `docs/character-progression-home-hub-implementation.md` 实现，不受旧核心 spec 的“无天赋/Meta 空”限制。新游戏必须先在启动选人屏选择骑士或刺客；正常战斗中不再切人物。宠物只做“暂未开放”，当前闯关只有 `endless_td` 无尽塔防：第 10 波后不强制结算，验收与可玩主区间是 1–10 波。
...
- 双武器槽（元气骑士）：右下攻击键左侧一个切换圆钮。点钮或 `Q` 在已填武器槽 0、已填武器槽 1、以及非空炮台手之间循环。新枪填空槽，两槽都满则替换当前槽。炮台手只用于放置，攻击仍用上次选中的武器。骑士始终 1 把持械叠层，技能升级加冲刺伤害/范围/体型，不再浮剑 1/2/3 发。选人「皮肤」不列出霜晶持械——那是霜晶战士技能变身后的形态。
